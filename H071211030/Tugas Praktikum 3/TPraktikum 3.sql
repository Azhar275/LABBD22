...
-- VALUE (2705, 'Ikram', 'Muhammad', 'x3227', 'kiflan@enhanceronly.com', 1, 1102,'Broker');
-- 
-- INSERT INTO employees
-- VALUE (2706, 'Jindra', 'Gamanto', 'x3322', 'waskita.bambang@yahoo.com', 1, 2705, 'Gangster');
-- 
-- INSERT INTO employees (employeeNumber, firstName, extension, officeCode, reportsTo, jobTitle)
-- VALUE (2707, 'Vanesa', 'x3219', 7, '1002', 'Mafia');
