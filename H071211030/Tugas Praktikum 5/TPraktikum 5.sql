...
-- WHERE orders.status ='On Hold' and comments LIKE '%limit%' ;
...
-- VALUES ('10424',CURRENT_DATE(),CURRENT_DATE() + INTERVAL 1 YEAR,NULL,'In Process',NULL,'465');
-- SELECT * FROM orders WHERE customerNumber = '465';
-- 
-- INSERT INTO orderdetails(orderNumber, productCode, quantityOrdered, priceEach, orderLineNumber)
-- VALUES ('10424', 'S18_2957', '50', '62.46', '1');
-- SELECT * FROM orderdetails WHERE orderNumber = '10424';
-- 
