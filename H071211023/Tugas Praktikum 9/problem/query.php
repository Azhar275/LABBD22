...
class MyQuery
{
  ...
  function show_data()
  {
    ...
    // Todo [1] : Buatkan query untuk menampilkan 5 data pelanggan terbaru berdasarkan waktu order
    $sql = "SELECT customers.customerNumber as id, customers.customerName as nama, orders.orderDate as tanggal
            FROM customers
            JOIN orders
