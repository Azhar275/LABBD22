SELECT * FROM ORDERS WHERE customernumber = '465'; -- nomor4
SELECT * FROM Customers WHERE customername LIKE "%ANTON%"; -- nomor4
SELECT * FROM products WHERE productName LIKE "%v8 coupe%"; -- nomor4
SELECT * from orders; 
SELECT * from orderdetails Order By orderLineNumber DESC;
SELECT * FROM orderdetails;
select * from products;
SELECT * from orderdetails where productCode ='S18_2957'; -- nomor4
SELECT DISTINCT status FROM orders; -- nomor1
