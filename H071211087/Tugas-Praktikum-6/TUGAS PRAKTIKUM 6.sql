...
-- Nomor 3
-- SELECT DATE_FORMAT(`PaymentDate`,'%M %Y') AS 'Hari Pembayaran', COUNT(customers.customerNumber) AS 'Jumlah Pelanggan', GROUP_concat(Customers.customerName SEPARATOR ",") AS 'List Pelanggan', SUM(Payments.amount) AS 'Jumlah Pembayaran' FROM customers
